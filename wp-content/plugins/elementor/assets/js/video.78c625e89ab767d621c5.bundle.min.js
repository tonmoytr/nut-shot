            ...
            class Video extends elementorModules.frontend.handlers.Base {
                ...
                playVideo() {
                    ...
                    const e = this.elements.$videoIframe,
                        t = e.data("lazy-load");
                    t && e.attr("src", t), this.getElementSettings("autoplay") && (e.attr("allow", "autoplay"), e[0].src = this.apiProvider.getAutoplayURL(e[0].src))
                }
                async animateVideo() {
                ...
                prepareYTVideo(e, t) {
                    const i = this.getElementSettings(),
                        o = {
                            ...
                            events: {
                                onReady: () => {
                                    i.mute && this.youtubePlayer.mute(), (i.autoplay || t) && this.youtubePlayer.playVideo()
                                },
                                onStateChange: t => {
                                    t.data === e.PlayerState.ENDED && i.loop && this.youtubePlayer.seekTo(i.start || 0)
                                }
                            },
                            playerVars: {
                    ...
                    i.yt_privacy && (o.host = "https://www.youtube-nocookie.com", o.origin = window.location.hostname), this.youtubePlayer = new e.Player(this.elements.$video[0], o)
                }
                bindEvents() {
                ...
                onInit() {
                    ...
                    }), void this.intersectionObserver.observe(this.elements.$video.parent()[0])) : void this.apiProvider.onApiReady((e => this.prepareYTVideo(e)))
                }
                onElementChange(e) {

! function(e, t) {
    ...
    window.ElementsKit_Helper = {}, ElementsKit_Helper.setURLHash = function(t, n, i) {
        ...
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                t.addClass("ekit-ajax-loading"), n.removeClass(a).addClass(o), e(document).width() <= Number(s) ? n.css({
                    border: "none"
                }) : n.css({
                    "padding-right": 0,
                    "margin-right": "5px"
            ...
            success: function(s) {
                t.removeClass("ekit-ajax-loading"), i.replaceWith(s), n.removeClass(o).addClass(a).removeAttr("style"), t.find(".elementor-element").each((function() {
        ...
        if ("function" != typeof Swiper) {
            return new(0, t.utils.swiper)(i, n).then((e => e))
        } {
    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                ...
                if ("hover" === a || i === this) !l && s ? .url && window.open(s.url, d);
                else {
        ...
        Nav_Menu: function(t) {
            if (t.find(".elementskit-megamenu-has").length > 0) {
                ...
                e(window).on("resize", (function() {
                    ...
                    }), t && t !== undefined ? "string" == typeof t ? (/^[0-9]/.test(t), a(i, t, n)) : i.css({
                        width: t + "px"
                    }) : a(i, t, n)
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(n) {
                    ...
                    t.find(".elementskit-dropdown-has").not(s).find(">.elementskit-dropdown, >.elementskit-megamenu-panel").removeClass("ekit-dropdown-open-onclick"), a.toggleClass("ekit-dropdown-open-onclick")
                })), e(window).on("resize", (function() {
        ...
        Countdown_Timer: function(t) {
            ...
            for (let e in i) i.hasOwnProperty(e) && "string" == typeof i[e] && (i[e] = i[e].replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;"));
            if (n.length) {
            ...
            if (l.length) {
                ...
                l.theFinalCountdown(d.ekitCountdown, (function(e) {
                    m(c.s, e.offset.seconds, s), m(c.m, e.offset.minutes, i), m(c.h, e.offset.hours, a), m(c.d, e.offset.days, o), m(c.w, e.offset.weeks, r), c.s = e.offset.seconds, c.m = e.offset.minutes, c.h = e.offset.hours, c.d = e.offset.days, c.w = e.offset.weeks
                })).on("finish.countdown", (function() {
            ...
            ElementsKit_Helper ? .observeElement(n[0], (e => {
                n.easyPieChart({
                    barColor: !0 === a.gradientChart ? function(e) {
                        ...
                        return i.addColorStop(0, a.gradientColor1), i.addColorStop(1, a.gradientColor2), i
                    } : a.barColor,
        ...
        Header_Search: function(t) {
            ...
            n.magnificPopup({
                ...
                callbacks: {
                    ...
                    open: function() {
                        i.css("overflow", "hidden"), i.find(".mfp-close").addClass("ekit-popup-close")
                    },
                    close: function() {
                        i.css("overflow", "auto"), i.find(".mfp-close").removeClass("ekit-popup-close")
                    }
                }
            })
        },
            ...
            if (i.length > 0) {
                const o = {
                    ...
                    callbacks: {
                        ...
                        close: function() {
                            e("body").find(".mfp-close").removeClass("ekit-popup-close"), t.find("video").each((function() {
                                this.pause()
                            }))
                        }
                    }

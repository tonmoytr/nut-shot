    ...
    var e = {
            ...
            widgetSection: function(i) {
                function a(t) {
                    ...
                    !e.editorCheck() && i.hasClass("wpr-jarallax") ? (i.css("background-image", "url(\"" + i.attr("bg-image") + "\")"), i.jarallax({
                    ...
                    function a() {
                        if (!i.hasClass("wpr-sticky-section-yes") && !i.find(".wpr-sticky-section-yes-editor")) return void(T = "relative");
                        ...
                        s.forEach((e, t) => {
                            if (e[1] > l) {
                                ...
                                w = "desktop" == r ? i.data("settings") ? _ + i.data("settings").wpr_sticky_effects_offset : _ + i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-offset-settings") : i.data("settings") ? _ + i.data("settings")["wpr_sticky_effects_offset_" + r] : _ + i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-offset-settings"), -1 === p.indexOf(e[0]) ? (T = -1 === c ? .indexOf(e[0]) ? a[t - 1] ? a[t - 1] : n : "relative", a[t] = T) : -1 !== p.indexOf(e[0]) && (T = n)
                            }
                        });
                        var d = function() {
                            let e = m.scrollTop();
                            "fixed" != T && ("top" === o && (e > _ ? r() : e <= _ && i.css({
                                position: "relative"
                            })), "bottom" === o && (e + x <= t(document).height() - k ? r() : i.css({
                                position: "relative"
                            }))), "relative" !== T && (e > w ? "yes" == i.data("wpr-replace-header") ? "yes" === i.data("wpr-sticky-hide") ? (e >= _ && i.addClass("wpr-visibility-hidden"), e < h && i.next().addClass(v).addClass("wpr-" + u + "-in")) : (i.addClass("wpr-visibility-hidden"), i.next().addClass(v).addClass("wpr-" + u + "-in")) : i.addClass("wpr-sticky-header") : e <= w && ("yes" == i.data("wpr-replace-header") ? (i.next().removeClass(v), i.removeClass("wpr-visibility-hidden"), i.next().removeClass("wpr-" + u + "-in")) : i.removeClass("wpr-sticky-header"))), "yes" === i.data("wpr-sticky-hide") && e >= _ && (e < h ? "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + u + "-out"), i.next().addClass("wpr-" + u + "-in")) : (i.removeClass("wpr-" + u + "-out"), i.addClass("wpr-" + u + "-in")) : "yes" === i.data("wpr-replace-header") ? (i.next().removeClass("wpr-" + u + "-in"), i.next().addClass("wpr-" + u + "-out")) : (i.removeClass("wpr-" + u + "-in"), i.addClass("wpr-" + u + "-out"))), clearTimeout(f), f = setTimeout(() => {
                                h = e
                            }, 10)
                        };
                        "sticky" == T ? t(window).scroll(d) : "fixed" == T && (r(), t(window).scroll(d)), "yes" == i.data("wpr-replace-header") && 0 != i.next().length && i.next().get(0).style.setProperty("--wpr-animation-duration", z);
                        let f
                    }

                    function r() {
                        var e = +window.innerHeight - (+i.css("top").slice(0, -2) + i.height()),
                            a = +window.innerHeight - (+i.css("bottom").slice(0, -2) + i.height());
                        "yes" === i.data("wpr-sticky-hide") && h < m.scrollTop() || ("" == b && (b = "fixed"), i.css({
                            position: b
                        }), t(".wpr-close-cart span").trigger("click"))
                    }

                    function s() {
                        t("#wpadminbar").length && (S = t("#wpadminbar").css("height").slice(0, t("#wpadminbar").css("height").length - 2), "top" === o && "fixed" == i.css("position") && (i.css("top", +S + j + "px"), i.css("bottom", "auto")))
                    }
                    ...
                    var z = i.attr("data-wpr-animation-duration") ? i.attr("data-wpr-animation-duration") + "s" : "500s";
                    if (0 < i.closest("div[data-elementor-type=\"wp-post\"]").length ? g = i.closest("div[data-elementor-type=\"wp-post\"]") : 0 < i.closest("div[data-elementor-type=\"header\"]").length ? g = i.closest("div[data-elementor-type=\"header\"]") : 0 < i.closest("div[data-elementor-type=\"footer\"]").length && (g = i.closest("div[data-elementor-type=\"footer\"]")), i.find(".wpr-sticky-section-yes-editor").length || (n = i.attr("data-wpr-position-type"), o = i.attr("data-wpr-position-location"), d = i.attr("data-wpr-position-offset"), p = i.attr("data-wpr-sticky-devices"), c = i.attr("data-wpr-active-breakpoints"), y = i.attr("data-wpr-z-index")), "top" === o && "auto" === i.css("top")) {
                        var j = 0;
                        i.css("top", 0)
                    } else var j = +i.css("top").slice(0, -2);
                    if (0 == p.length && (n = "relative"), e.editorCheck() && p) {
                        var P = i.find(".wpr-sticky-section-yes-editor").attr("data-wpr-sticky-devices");
                        i.attr("data-wpr-sticky-devices", P), p = i.attr("data-wpr-sticky-devices")
                    }
                    a(), s(), t(window).smartresize(function() {
                        _ = i.offset().top, x = t(window).height(), C = i.outerHeight(!0), k = t(document).height() - (_ + C), l = t("body").prop("clientWidth") + 17, t(window).scrollTop() <= w && a()
                    }), f || (T = "relative")
                }()
            },
            ...
            widgetGrid: function(a) {
                ...
                function d(e) {
                    ...
                    var M = +elementorFrontend.config.responsive.breakpoints.mobile.value,
                        H = +elementorFrontend.config.responsive.breakpoints.mobile_extra.value,
                        R = +elementorFrontend.config.responsive.breakpoints.tablet.value,
                        V = +elementorFrontend.config.responsive.breakpoints.tablet_extra.value,
                ...
                if (h.length) {
                    ...
                    if (H.observe(a[0], {
                        ...
                        var R = h.find(".wpr-grid-item-add-to-cart").find("i"),
                            V = R.attr("class");
                        R.length && (V = V.substring(V.indexOf("fa-"), V.length)), t("body").on("adding_to_cart", function(e, t) {
                            t.fadeTo("slow", 0)
                            ...
                            R.length && (s.find("i").removeClass(V).addClass("fa-check"), setTimeout(function() {
                                s.find("i").removeClass("fa-check").addClass(V)
                            }, 3500))
                        })
                    }
            ...
            widgetMagazineGrid: function(i) {
                ...
                if ("yes" !== a.find(".wpr-grid-media-wrap").attr("data-overlay-link") || e.editorCheck() || (a.find(".wpr-grid-media-wrap").css("cursor", "pointer"), a.find(".wpr-grid-media-wrap").on("click", function(e) {
                        ...
                        if (-1 !== i.indexOf("inner-block") || -1 !== i.indexOf("wpr-cv-inner") || -1 !== i.indexOf("wpr-grid-media-hover")) {
                            ...
                            if (a.find(".wpr-grid-item-title a").length && r) try {
                                var s = new URL(r);
                                if (["http:", "https:"].includes(s.protocol)) {
                                    var n = s.href;
                                    "_blank" === a.find(".wpr-grid-item-title a").attr("target") ? window.open(n, "_blank").focus() : window.location.href = n
                                } else console.error("Invalid URL scheme:", s.protocol)
                            } catch (t) {
                    ...
                    0 < i.find(".wpr-category-select").length && !d && ("product" == i.find(".wpr-search-form-input").attr("wpr-query-type") ? d = "product_cat" : d = "category"), s = setTimeout(() => {
                        ...
                        t.ajax({
                            ...
                            data: {
                                ...
                                wpr_show_ps_pt: i.find(".wpr-search-form-input").attr("password-protected")
                            },
                            success: function(e) {
            ...
            widgetFlipBox: function(e) {
                ...
                window.addEventListener("pageshow", function(e) {
                    e.persisted && i.hasClass("wpr-flip-box-active") && i.removeClass("wpr-flip-box-active")
                }), window.addEventListener("popstate", function() {
                    i.hasClass("wpr-flip-box-active") && i.removeClass("wpr-flip-box-active")
            ...
            widgetFeatureList: function(e) {
                ...
                const a = document.querySelector(".e-n-tabs-content>div");
                if (a) {
                    const e = new MutationObserver(function(e) {
                        for (let t of e)("attributes" === t.type || "childList" === t.type) && i()
                    });
                    e.observe(a, {
                        attributes: !0,
                        childList: !0,
            ...
            widgetMiniCompare: function(a) {
                0 < a.find(".wpr-compare-count").length && 0 == a.find(".wpr-compare-count").text() || a.find(".wpr-compare-count").css("display", "inline-flex"), a.hasClass("wpr-compare-style-popup") && (a.find(".wpr-compare-toggle-btn").on("click", function(i) {
                    ...
                    success: function(e) {
                        let t = e.compare_count;
                        "none" == a.find(".wpr-compare-count").css("display") && 0 < t ? (a.find(".wpr-compare-count").text(t), a.find(".wpr-compare-count").css("display", "inline-flex")) : 0 == t ? (a.find(".wpr-compare-count").css("display", "none"), a.find(".wpr-compare-count").text(t)) : a.find(".wpr-compare-count").text(t)
                    },
                    error: function(e) {
                        console.log(e)
                    }
                        ...
                        function(e) {
                            ...
                            if (a) {
                                ...
                                Promise.all(h.map(e => {
                                    ...
                                    console.log(a);
                                    const r = a.find(e => e && "wpr_form_builder_submissions" === e.data.action),
                                        s = r ? r.data.post_id : null;
                                    var n = h.map(t => {
                                        if ("redirect" !== t) {
                                            t = "wpr_form_builder_" + t;
                                            const i = a.find(e => e && e.data.action === t),
                                                r = i ? i.data.message : "";
                                            if (i && "success" === i.data.status) {
                                                if (p.push("success"), s) return e(s, t, "success", r);
                                            } else if (p.push("error"), s) return e(s, t, "error", r)
                                        }
                                    });
                                    return Promise.all(n).then(() => {
                                        if (p.includes("error")) {
                                            var e = t("<div>").text(i.data("settings").error_message).html();
                                            i.find("form").append("<p class=\"wpr-submit-error\">" + e + "</p>")
                                        } else i.find("form").append(t("<p class=\"wpr-submit-success\"></p>").text(i.data("settings").success_message)), i.find("button").attr("disabled", !0), i.find("button").css("opacity", .6)
                                    })
                                }).catch(e => {
                                    console.error(e)
                                }).then(() => {
            ...
            widgetProductMiniCart: function(i) {
                function a() {
                    t.ajax({
                        ...
                        success: function(e) {
                            e && e.fragments && (t.each(e.fragments, function(e, i) {
                                t(e).replaceWith(i)
                ...
                function r() {
                    i.find(".wpr-close-cart span").on("click", function() {
                        i.find(".wpr-shopping-cart-inner-wrap").addClass("wpr-mini-cart-slide-out"), i.find(".wpr-mini-cart-slide-out").css("animation-speed", s), i.find(".wpr-shopping-cart-wrap").fadeOut(s), t("body").removeClass("wpr-mini-cart-sidebar-body"), setTimeout(function() {
                ...
                window.addEventListener("pageshow", function(e) {
                    (e.persisted || window.performance && 2 === window.performance.navigation.type) && a()
                }), t(document.body).on("updated_wc_div", function() {
                    a()
                }), i.find(".wpr-mini-cart").css({
                    display: "none"
                });
                var s = i.find(".wpr-mini-cart-wrap").data("animation");
                t("body").on("click", function(t) {
                    t.target.classList.value.includes("wpr-mini-cart") || t.target.closest(".wpr-mini-cart") || (i.find(".wpr-mini-cart-toggle-btn").closest(".elementor>.elementor-element").removeClass("wpr-z-index"), i.hasClass("wpr-mini-cart-slide") ? i.find(".wpr-mini-cart").slideUp(s) : i.find(".wpr-mini-cart").fadeOut(s))
                }), i.hasClass("wpr-mini-cart-sidebar") && (t("#wpadminbar").length && i.find(".wpr-mini-cart").css({
                    "z-index": 999999
                }), r(), i.find(".wpr-shopping-cart-wrap").on("click", function(a) {
                    a.target.classList.value.includes("wpr-shopping-cart-inner-wrap") || a.target.closest(".wpr-shopping-cart-inner-wrap") || (i.find(".wpr-shopping-cart-inner-wrap").addClass("wpr-mini-cart-slide-out"), i.find(".wpr-mini-cart-slide-out").css("animation-speed", s), i.find(".wpr-shopping-cart-wrap").fadeOut(s), t("body").removeClass("wpr-mini-cart-sidebar-body"), setTimeout(function() {
                        i.find(".wpr-shopping-cart-inner-wrap").removeClass("wpr-mini-cart-slide-out"), i.find(".wpr-mini-cart").css({
                            display: "none"
                        })
                    }, s + 100))
                    ...
                    a.stopPropagation(), a.preventDefault(), "none" === i.find(".wpr-mini-cart").css("display") ? (t(this).closest(".elementor>.elementor-element").addClass("wpr-z-index"), i.hasClass("wpr-mini-cart-slide") ? i.find(".wpr-mini-cart").slideDown(s) : i.find(".wpr-mini-cart").fadeIn(s), i.hasClass("wpr-mini-cart-sidebar") && (i.find(".wpr-shopping-cart-wrap").fadeIn(s), i.find(".wpr-shopping-cart-inner-wrap").addClass("wpr-mini-cart-slide-in"), i.find(".wpr-mini-cart-slide-in").css("animation-speed", s), t("body").addClass("wpr-mini-cart-sidebar-body")), setTimeout(function() {
                    ...
                    }, s + 100)) : (t(this).closest(".elementor>.elementor-element").removeClass("wpr-z-index"), i.hasClass("wpr-mini-cart-slide") ? i.find(".wpr-mini-cart").slideUp(s) : i.find(".wpr-mini-cart").fadeOut(s))
                });
                var n = new MutationObserver(function() {
                    i.hasClass("wpr-mini-cart-sidebar") && r(), i.find(".woocommerce-mini-cart-item").on("click", ".wpr-remove-item-from-mini-cart", function() {
